...
- Form Recognizer: S0(Standard) Tier は、あらかじめ構築されたレイアウトを使用します。価格はドキュメント 1 ページあたり、サンプルドキュメントは合計 261 ページです。[価格](https://azure.microsoft.com/pricing/details/form-recognizer/)
